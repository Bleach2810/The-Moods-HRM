        ...
        <div className="card space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-[#FAF9F6] border border-[#7c4831]/10 rounded-xl space-y-1 text-center">
              ...
              <p className="text-sm font-mono font-black text-[#7c4831]">{timekeeping.clockInTime || "--:--"}</p>
            </div>
            <div className="p-3 bg-[#FAF9F6] border border-[#7c4831]/10 rounded-xl space-y-1 text-center">
              <span className="text-[9px] font-bold text-[#7c4831]/60 uppercase tracking-wider">Giờ ra</span>
              <p className="text-sm font-mono font-black text-[#7c4831]">{timekeeping.clockOutTime || "--:--"}</p>
            </div>
          </div>
      ...
      <div className="space-y-5 pb-28 anim-fadeUp">
        ...
        <form onSubmit={handleSaveProfile} className="card space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input type="text" disabled value={activeStaff.phone || "0900000003"} className="input w-full text-sm opacity-60 cursor-not-allowed font-mono font-bold" />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <input type="text" disabled value={`${(activeStaff.hourlyWage || 25000).toLocaleString("vi-VN")}đ/giờ`} className="input w-full text-sm opacity-60 cursor-not-allowed font-semibold font-mono" />
          </div>
          <div className="space-y-1.5">
